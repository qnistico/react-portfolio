  ...
  return (
    ...
    >
      ...
      >
        {/* Gradient blobs */}
        <motion.div
          className="hero-blob-1 absolute top-1/4 right-1/4 w-96 h-96 rounded-full bg-gradient-to-r from-blue/20 to-blue/5 blur-3xl"
          animate={{
            scale: [1, 1.2, 1],
            x: [0, 30, 0],
            y: [0, -20, 0],
        ...
        />
        <motion.div
          className="hero-blob-2 absolute bottom-1/4 left-1/4 w-80 h-80 rounded-full bg-gradient-to-r from-blue/10 to-transparent blur-3xl"
          animate={{
            scale: [1, 1.3, 1],
            x: [0, -20, 0],
            y: [0, 30, 0],
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              ...
              <div className="hero-portrait-glow absolute inset-0 bg-blue/20 rounded-full blur-3xl scale-90" />
      ...
      {/* Scroll indicator - clickable to scroll to expertise section */}
      <motion.button
      ...
      >
        <motion.div
          className="w-6 h-10 rounded-full border-2 border-text/30 flex justify-center pt-2 hover:border-blue transition-colors"
          animate={{ y: [0, 5, 0] }}
